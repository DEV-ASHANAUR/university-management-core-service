...
import { offeredCourseClassScheduleUtils } from './offeredCourseClassSchedule.utlis';
...
const getByIdFromDB = async (
  ...
  const result = prisma.offeredCourseClassSchedule.findUnique({
    where: { id },
    include: {
      offeredCourseSection: true,
      faculty: true,
...
const updateOneInDB = async (
  ...
  const result = prisma.offeredCourseClassSchedule.update({
    where: { id },
    data: payload,
    include: {
      offeredCourseSection: true,
...
const deleteByIdFromDB = async (
  ...
  const result = prisma.offeredCourseClassSchedule.delete({
    where: { id },
    include: {
      offeredCourseSection: true,
      faculty: true,
