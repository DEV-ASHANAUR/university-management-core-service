...
const initFacultyEvents = () => {
    ...
    redis_1.RedisClient.subscribe(faculty_constants_1.EVENT_FACULTY_DELETED, (e) => __awaiter(void 0, void 0, void 0, function* () {
        const data = JSON.parse(e);
        yield faculty_service_1.FacultyService.deleteFacultyFromEvent(data);
    }));
};
