...
const assignCourses = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const existingCourseAssignments = yield prisma_1.default.courseFaculty.findMany({
        where: {
            facultyId: id,
    ...
    const assignCourseData = yield prisma_1.default.courseFaculty.findMany({
        where: {
            facultyId: id,
        },
        include: {
...
const deleteFacultyFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.default.faculty.findFirst({
        where: {
            facultyId: e === null || e === void 0 ? void 0 : e.id,
        },
    });
    if (!isExist) {
        createFacultyFromEvent(e === null || e === void 0 ? void 0 : e.id);
    }
    else {
        yield prisma_1.default.faculty.deleteMany({
            where: {
                facultyId: e === null || e === void 0 ? void 0 : e.id,
            }
        });
