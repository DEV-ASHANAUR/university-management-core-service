...
const createAcademicFaculty = (academicFacultyData) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.default.academicFaculty.findFirst({
        where: {
            title: academicFacultyData.title,
        },
    });
    if (isExist) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Academic Faculty is already exist!');
    }
...
const getDataById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.academicFaculty.findUnique({ where: { id } });
    return result;
});
