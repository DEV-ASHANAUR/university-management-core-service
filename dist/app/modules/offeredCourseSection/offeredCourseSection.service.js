...
const offeredCourseClassSchedule_utlis_1 = require("../offeredCourseClassSchedule/offeredCourseClassSchedule.utlis");
...
const insertIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, utils_1.asyncForEach)(classSchedules, (schedule) => __awaiter(void 0, void 0, void 0, function* () {
        yield offeredCourseClassSchedule_utlis_1.offeredCourseClassScheduleUtils.checkRoomAvailable(schedule);
        yield offeredCourseClassSchedule_utlis_1.offeredCourseClassScheduleUtils.checkFacultyAvailable(schedule);
    }));
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (offeredCourseSection_constant_1.offeredCourseSectionRelationalFields.includes(key)) {
                    return {
                        [offeredCourseSection_constant_1.offeredCourseSectionRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
