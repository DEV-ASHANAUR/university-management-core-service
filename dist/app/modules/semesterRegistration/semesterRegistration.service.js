...
const insertIntoDB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isAnySemesterRegUpcomingOrOngoing) {
        throw new ApiError_1.default(http_status_1.default.BAD_GATEWAY, `There is already an ${isAnySemesterRegUpcomingOrOngoing.status} registration.`);
    }
        ...
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (semesterRegistration_constant_1.semesterRegistrationRelationalFields.includes(key)) {
                    return {
                        [semesterRegistration_constant_1.semesterRegistrationRelationalFieldMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
...
const confirmMyregistration = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (studentSemesterRegistration.totalCreditTaken === 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'You are not enroll in any course!');
    }
    if (studentSemesterRegistration.totalCreditTaken &&
...
const startNewSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.$transaction((prismaTransactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const studentSemesterRegistration = yield prisma_1.default.studentSemesterRegistration.findMany({
            where: {
                semesterRegistration: {
                    id,
                },
        ...
        yield (0, utils_1.asyncForEach)(studentSemesterRegistration, (studentSemReg) => __awaiter(void 0, void 0, void 0, function* () {
            if (studentSemReg.totalCreditTaken) {
                const totalSemesterPaymentAmount = studentSemReg.totalCreditTaken * 5000;
            ...
            yield (0, utils_1.asyncForEach)(studentSemesterRegistrationCourse, (item) => __awaiter(void 0, void 0, void 0, function* () {
                ...
                if (!isExistEnrolledData) {
                    ...
                    yield studentEnrolledCourseMark_service_1.StudentEnrolledCourseMarkService.createStudnetEnrolledCourseDefaultMark(prismaTransactionClient, {
                        studentId: item.studentId,
