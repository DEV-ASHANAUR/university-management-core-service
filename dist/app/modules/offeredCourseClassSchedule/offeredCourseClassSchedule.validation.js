...
const offeredCourseSection_constant_1 = require("../offeredCourseSection/offeredCourseSection.constant");
...
const create = zod_1.z
    .object({
    body: zod_1.z.object({
        dayOfWeek: zod_1.z.enum([...offeredCourseSection_constant_1.daysInWeek], {
