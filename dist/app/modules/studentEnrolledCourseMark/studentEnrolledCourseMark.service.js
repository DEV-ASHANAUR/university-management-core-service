...
const createStudnetEnrolledCourseDefaultMark = (prismaClient, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isExistFianlData = yield prismaClient.studentEnrolledCourseMark.findFirst({
        where: {
...
const updateFinalMarks = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fianlTermMarks = ((_b = studentEnrolledCourseMarks.find(item => item.examType === client_1.ExamType.FINAL)) === null || _b === void 0 ? void 0 : _b.marks) || 0;
    const totalFinalMarks = Math.ceil(midTermMarks * 0.4) + Math.ceil(fianlTermMarks * 0.6);
