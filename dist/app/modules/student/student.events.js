...
const initStudentEvents = () => {
    ...
    redis_1.RedisClient.subscribe(student_constants_1.EVENT_STUDENT_DELETED, (e) => __awaiter(void 0, void 0, void 0, function* () {
        const data = JSON.parse(e);
        yield student_service_1.StudentService.deleteStudentFromEvent(data);
    }));
};
