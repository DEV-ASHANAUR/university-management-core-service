...
const create = (studentData) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudentFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        ...
        const student = {
            ...
            firstName: e.student.name.firstName,
            lastName: e.student.name.lastName,
            middleName: e.student.name.middleName,
            profileImage: e.student.profileImage,
            email: e.student.email,
            contactNo: e.student.contactNo,
            gender: e.student.gender,
            bloodGroup: e.student.bloodGroup,
            academicDepartmentId: e.student.academicDepartment.syncId,
            academicFacultyId: e.student.academicFaculty.syncId,
            academicSemesterId: e.student.academicSemester.syncId,
        };
...
const deleteStudentFromEvent = (e) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield prisma_1.default.student.findFirst({
        where: {
            studentId: e.id,
        },
